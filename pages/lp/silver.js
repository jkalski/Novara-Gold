...
export default function SilverLandingPage() {
    ...
    try {
      const res = await fetch('/api/contact', {
        ...
        body: JSON.stringify({
          ...
          subject: formType === 'portfolio-review' ? 'Portfolio Review Request (Silver Landing Page)' : '',
          message: formType === 'portfolio-review'
            ? `Requested a portfolio review via the Silver landing page.\nPreferred Date: ${formData.preferredDate || 'Not specified'}\nPreferred Time: ${formData.preferredTime || 'Not specified'}`
            : '',
          turnstileToken,
        }),
      })
  ...
  return (
    <>
      <Head>
        <title>There&apos;s No Such Thing as Free Silver | Novara Gold</title>
        <meta
          name="description"
          content="Free silver offers aren't a bonus — they're a distraction that costs you. Learn the truth before you invest."
        />
      ...
      <div className="lp-page">
        ...
        {/* ── Hero ── */}
        <section className="lp-hero lp-hero-silver">
          <div className="lp-hero-overlay" />
          <div className="lp-hero-content lp-hero-content-left">
            <p className="lp-hero-eyebrow">GOLD IRA TRUTH MOST PEOPLE NEVER HEAR</p>
            <h1 className="lp-hero-headline">
              THERE&apos;S NO SUCH THING<br />
              <span className="lp-hero-gold">AS FREE SILVER.</span>
            </h1>
          ...
          <div className="lp-video-grid">
            ...
            <button className="lp-video-thumb-btn" onClick={() => setVideoOpen(true)} aria-label="Play video">
              <div className="lp-video-thumb-img">
                <Image
                  src="https://img.youtube.com/vi/FNTfjNAr6p8/maxresdefault.jpg"
                  alt="Watch the video"
                  fill
            ...
            <div className="lp-video-content">
              ...
              <h2 className="lp-video-title">
                A Retired White Collar Crime Investigator Reveals the Truth Behind &ldquo;Free Silver&rdquo; Offers
              </h2>
              <p className="lp-video-desc">
                He&rsquo;s seen the tricks dealers use.{' '}
                <span className="lp-gold-text">Now he&rsquo;s breaking it down so you don&rsquo;t get played.</span>
              </p>
              <ul className="lp-video-bullets">
                <li><span className="lp-bullet-check">&#10003;</span> Why &ldquo;free&rdquo; silver usually isn&rsquo;t free</li>
                <li><span className="lp-bullet-check">&#10003;</span> How these offers are designed to lock you in</li>
                <li><span className="lp-bullet-check">&#10003;</span> What smart investors look for instead</li>
              </ul>
            </div>
          </div>
...
SilverLandingPage.getLayout = (page) => page
